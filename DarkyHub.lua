...
local Config = {
    ...
    ServiceId       = 30662, -- Your PlatoBoost Service ID
    PlatoSecret     = "ae477d26-f663-484f-aa2b-aad70f6874bd", -- Your PlatoBoost Secret Key
    ...
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/sokpanha10000-oss/DarkyUI/refs/heads/main/DarkyHUB.lua", -- The raw URL of your main script
    ...
    HubName         = "Darky Hub", -- The main title shown at the top of the GUI
    HubDescription  = "Get key and paste" -- The text shown below the title
}
